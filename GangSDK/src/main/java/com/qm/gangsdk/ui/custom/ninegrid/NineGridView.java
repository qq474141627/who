package com.qm.gangsdk.ui.custom.ninegrid;
...
//                gridWidth = gridHeight = (totalWidth - gridSpacing * (columnCount - 1)) / columnCount;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            ImageLoadUtil.loadNormalImage(childrenView,  mImageInfo.get(i).getThumbnailUrl());
        }
    }
            ...
            mImageLoader = new ImageLoader() {
                ...
                public void onDisplayImage(Context context, final ImageView imageView, String url) {
                    if(imageView != null && url != null){
                        ImageLoadUtil.loadNormalImage(imageView, url);
                    }
                }
