...
public class ImageLoadUtil {
    ...
    public static void displayImage(ImageView imageView, String url) {
        ...
        Glide.with(GangSDKCore.getInstance().getContext()).load(url).placeholder(R.mipmap.qm_icon_default_loading).fitCenter().dontAnimate().into(imageView);
    }
    ...
    public static void loadNormalImage(ImageView imageView, String url) {
        if(StringUtils.isEmpty(url)) return;
        Glide.with(GangSDKCore.getInstance().getContext()).load(url).placeholder(R.mipmap.qm_icon_default_loading).dontAnimate().into(imageView);
    }
    ...
    public static void loadRoundImage(ImageView imageView, String url) {
        if(StringUtils.isEmpty(url)) return;
        Glide.with(GangSDKCore.getInstance().getContext()).load(url).asBitmap().placeholder(R.mipmap.qm_icon_default_loading)
    ...
    public static void loadCircleImage(final ImageView imageView, String url) {
        if(StringUtils.isEmpty(url)) return;
        Glide.with(GangSDKCore.getInstance().getContext()).load(url).asBitmap().placeholder(R.mipmap.qm_icon_default_loading).centerCrop()
