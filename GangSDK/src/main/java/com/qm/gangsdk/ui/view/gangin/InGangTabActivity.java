...
public class InGangTabActivity extends XLBaseActivity {
    ...
    protected void initView() {
        ...
        btnGangCircle = (ImageButton) findViewById(R.id.btnGangCircle);
    ...
    private void isAllowedUseDynaimic(){
        if(GangConfigureUtils.isUsedDynamic()){
            btnGangCircle.setVisibility(View.VISIBLE);
        }else {
            btnGangCircle.setVisibility(View.GONE);
        }
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnGangCircle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GangModuleManage.toGangDynamicActivity(aContext);
            }
        });
    }
