...
import static com.qm.gangsdk.ui.view.common.DialogHintFragment.CallbackOnclick;
...
public class MemberInfoFragment extends XLBaseFragment{
    ...
    protected void initData() {
        ...
        if(bundle != null) {
            memberid = bundle.getInt(MEMBER_ID, -1);
        }
        loading.show();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        btnGangDynamic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(Integer.valueOf(memberid) != null && !StringUtils.isEmpty(nickname)) {
                    GangModuleManage.toUserDynamicActivity(aContext, memberid, nickname);
                }
            }
        });
    }
    ...
    private void bindData(final XLGangMemberInfoBean data) {
        nickname = StringUtils.getString(data.getNickname(), "");
